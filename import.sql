...
(8,'Germinales','Un classique ecrit par le grand écrivain Emile Zola','https://www.youtube.com/watch?v=rXfaHDOZ2mA','Livres',19,null,null,null,null,63, 63),
(9,'The godfather','un livre de Mario Puzo','https://www.youtube.com/watch?v=X-jdl9hcCeg','Livres',16,null,null,null,null,12, 99),
(10,'Je suis une supermaman !','un livre qui est visiblement destine aux mamans narcissiques',null,'Livres',3,null,null,null,null,12, 3),
(11,'Harry Potter vol.1','Probablement le livre le plus lu de l\'histoire après la bible !','https://www.youtube.com/watch?v=Yn_uHvb5vPQ','Livres',17,null,null,null,null,6666, 6666),
(12,'Hunger Games','devenu tres populaire recemment grace a sa sortie au cinema, ce bestseller aura vous faire trembler d\'exitation !','https://www.youtube.com/watch?v=wqUq0lsQ684','Livres',14,null,null,null,null,100, 17642),
(13,'Les miserables','Le grand classique de Victor Hugo','https://www.youtube.com/watch?v=ql_RjmRJEzw','Livres',12,null,null,null,null,38, 497),
(14,'Adele','musique pop 2000','https://www.youtube.com/results?search_query=adele+someone+like+you','Musique',10,null,null,null,null,3, 99),
(15,'Angele','Rap moderne et engage','https://www.youtube.com/watch?v=Hi7Rx3En7-k','Musique',10,null,null,null,null,389, 49745),
(16,'Beatles','Bon rock indemodable','https://www.youtube.com/watch?v=2Q_ZzBGPdqE','Musique',10,null,null,null,null,353, 1745),
(17,'Beyonce','un plaisir visuel... oui c\'est irronique quand on parle de musique','https://www.youtube.com/watch?v=4m1EFMoRFvY','Musique',10,null,null,null,null,832, 2165),
(18,'Bob Marley','Un icone du reggae','https://www.youtube.com/watch?v=pHlSE9j5FGY','Musique',10,null,null,null,null,290, 643),
(19,'Daft Punk','Des gens masques','https://www.youtube.com/watch?v=5NV6Rdv1a3I','Musique',10,null,null,null,null,970, 35567),
(20,'David Guetta','un dj francais surcote','https://www.youtube.com/watch?v=5dbEhBKGOtY','Musique',10,null,null,null,null,90, 567),
(21,'Johnny Halliday','l\'icone francaise du rock','https://www.youtube.com/watch?v=s3O1Xro7oAI','Musique',10,null,null,null,null,9, 7),
(22,'Jul','une erreur de la nature','https://www.youtube.com/watch?v=pDWVXdiK-p0','Musique',1,null,null,null,null,1, 1),
(23,'Justin','je suis a court la...','https://www.youtube.com/watch?v=DK_0jXPuIr0','Musique',10,null,null,null,null,57, 1987),
(24,'Michael Jackson','Star de la pop !','https://www.youtube.com/watch?v=QNJL6nfu__Q','Musique',10,null,null,null,null,521, 3387),
(25,'Nirvana','Vachement cool !','https://www.youtube.com/watch?v=hTWKbfoikeg','Musique',10,null,null,null,null,21, 337),
(26,'Queen','de loin le meilleur groupe de tout les temps !','https://www.youtube.com/watch?v=t99KH0TR-J4','Musique',12,null,null,null,null,2251, 598737),
(27,'Arc d\'entrainement','tres bon arc pour debuter','https://www.youtube.com/watch?v=Yekyf-l11wQ','Sports',53,null,null,null,null,21, 337),
(28,'Armure','Pour les samourais en herbe !','https://www.youtube.com/watch?v=a8v79oql2B0&t=253s','Sports',230,null,null,null,null,4, 36),
(29,'Balles Ping-Pong','des belles balles oranges','https://www.youtube.com/watch?v=UeG1ftTmLAg','Sports',6,null,null,null,null,80, 765),
(30,'Canoe','bon canoe entree de gamme pour debutants','https://www.youtube.com/watch?v=8oOPn1t0Wiw','Sports',99,null,null,null,null,8, 75),
(31,'Chaise Romaine','Quand la salle ne te suffit plus !','https://www.youtube.com/watch?v=v9qMlin2kS0','Sports',344,null,null,null,null,3, 29),
(32,'Halteres','Tres bon choix pour commencer la musculation','https://www.youtube.com/watch?v=XH2ov50EmgI','Sports',54,null,null,null,null,8, 70),
(33,'Kayak','un kayak de haut niveau reserve aux experts !','https://www.youtube.com/watch?v=ZJZk_EmtA4c','Sports',498,null,null,null,null,50, 710),
(34,'Lot d\'halteres','Pour halterophiles de niveau intermediaires','https://www.youtube.com/watch?v=vtAFr1khMYA','Sports',263,null,null,null,null,39, 602),
(35,'Raquette de Ping-Pong','Bonne raquette pour s\'ammuser le weekend','https://www.youtube.com/watch?v=-iOhlbabVS4','Sports',24,null,null,null,null,321, 502),
(36,'Raquette de tennis','Raquette tres polyvalente','https://www.youtube.com/watch?v=bq_RlLnZdCU','Sports',39,null,null,null,null,78, 472),
(37,'Table de Ping-Pong','Tres belle table avec le meilleur rapport qualité prix du marché !','https://www.youtube.com/watch?v=dX4Wl21Pr2c','Sports',199,null,null,null,null,68, 392),
(38,'Costume femme','Costume de tres bonne qualite','https://www.youtube.com/watch?v=65MZQyxvyEU','Vetements',301,1,1,0,1,7, 42),
...
(40,'Jean coupe slim','en gros c\'est un jean','https://www.youtube.com/watch?v=IhKXP6Tu-Z4','Vetements',58,1,1,0,1,19, 282),
(41,'Jean coupe strait','En gros c\'est un jean mais different','https://www.youtube.com/watch?v=WwkKmZyflRA','Vetements',54,1,1,0,1,45, 391),
(42,'Belle Robe','une robe ravisante qui soulignera elegamment vos courbes','https://www.youtube.com/watch?v=86_tK9UzHJY','Vetements',331,1,1,0,1,5, 39),
(43,'Short pour femme','short elegant pour l\'ete','https://www.youtube.com/watch?v=mWbEelaymck','Vetements',63,1,1,0,1,5, 39),
(44,'Short classique','Short avec une coupe classique','https://www.youtube.com/watch?v=T7ECB2i6xIM','Vetements',22,1,1,0,1,50, 343),

								...
								<tbody>
									...
									if($db_found){	
										...
										if(empty($research)){
											...
											// on select dans la base
											$sql = "SELECT * FROM vendeur WHERE Email_ECE = '".$research."'"; 
											$req = mysqli_query($db_handle, $sql); 
											while($data=mysqli_fetch_assoc($req))
											{
												echo("<tr>");
											...
											// on select dans la base
											$sql = "SELECT * FROM vendeur WHERE Pseudo = '".$research."'";  
											$req = mysqli_query($db_handle, $sql); 
											while($data=mysqli_fetch_assoc($req))
											{
												echo("<tr>");
											...
											// on select dans la base
											$sql = "SELECT * FROM vendeur WHERE Nom = '".$research."'"; 
											$req = mysqli_query($db_handle, $sql); 
											while($data=mysqli_fetch_assoc($req))
											{
												echo("<tr>");
											...
											// on select dans la base
											$sql = "SELECT * FROM vendeur WHERE Prenom = '".$research."'"; 
											$req = mysqli_query($db_handle, $sql); 
											while($data=mysqli_fetch_assoc($req))
											{
												echo("<tr>");

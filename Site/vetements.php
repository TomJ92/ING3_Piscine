					...
					<div class="card-columns" id="flash" style="width: 75%; margin: auto;">
						...
						<?php
							...
							if($db_found){	
								...
								$sql = "SELECT item.nom, item.description, item.prix, imgitem.nom_img FROM item INNER JOIN imgitem ON item.Id_item = imgitem.Id_item WHERE imgitem.Is_main = '1' AND Categorie='Vetements' ORDER BY item.vendu DESC"; 

<html>
	<head>
		<title>ECE Market Place | Vetements</title>
		<meta charset="utf-8"/>
		...
		<!-- Page Content -->
			...
			<div id="page-content-wrapper">
				...
				<!-- Text decoration to none pour enlever le surlignage du lien -->
					...
					<!-- Lien pour la page vetements -->
					<a href="vetements.php" style="text-decoration: none" ><h1>Vêtements</h1></a>
					...
					<div class="card-columns" id="flash" style="width: 75%; margin: auto;">
						...
						<?php
							...
							if($db_found){	
								...
								$sql = "SELECT item.id_item, item.nom, item.description, item.prix, imgitem.nom_img FROM item INNER JOIN imgitem ON item.Id_item = imgitem.Id_item WHERE imgitem.Is_main = '1' AND Categorie='Vetements' ORDER BY item.vendu DESC"; 
